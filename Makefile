...
vignettes/httppipe.Rmd: vignettes/src/httppipe.Rmd
	cd vignettes/src && ${RSCRIPT} -e 'knitr::knit("httppipe.Rmd")'
	mv vignettes/src/httppipe.md $@
	sed -i.bak 's/[[:space:]]*$$//' $@
	rm -f $@.bak

vignettes_install: vignettes/httppipe.Rmd
	${RSCRIPT} -e 'library(methods); devtools::build_vignettes()'

vignettes:
	rm -f vignettes/httppipe.Rmd
